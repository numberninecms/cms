...
/**
 * @Route("/users/check-email-availability/{email}", name="numbernine_admin_users_check_email_availability", options={"expose"=true}, methods={"GET"})
 */
final class UserCheckEmailAvailabilityAction extends AbstractController implements AdminController
{
    public function __invoke(ResponseFactory $responseFactory, UserRepository $userRepository, string $email): JsonResponse
    {
